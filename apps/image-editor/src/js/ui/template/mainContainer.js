        ...
        <div class="tui-image-editor-workspace">
            <div class="tui-image-editor-controls tui-image-editor-left-palette left-palette">
                <div class="tui-image-editor-palette-header">
                    <span class="tui-image-editor-palette-title">${(locale && locale.localize('Toolbar')) || '工具栏'}</span>
                    <button type="button" class="tui-image-editor-palette-toggle-btn" title="${(locale && locale.localize('Collapse')) || '折叠工具栏'}">▲</button>
                </div>
